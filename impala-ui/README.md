...
Vanilla JavaScript SPA using the Foundation 6.8.1 CSS framework (loaded from the jsDelivr CDN).
No build step or transpilation — static HTML/CSS/JS served by Nginx. All JS modules use the IIFE
(Immediately Invoked Function Expression) pattern exposing a single named global.
